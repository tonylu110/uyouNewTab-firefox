    ...
    elemenetGetId('useLink').onclick = function () {
        ...
        if (changeLinkInput == 'http://') {
            ...
            if (elemenetGetId('linkNum').className == 'link1') {
                browser.storage.local.set({ 'link1Img': linkImgUrl });
                browser.storage.local.set({ 'link1Padding': num });
                browser.storage.local.set({ 'link1Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link1Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link1': changeLinkInput })
                change('1');
                elemenetGetId('link1').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link2') {
                browser.storage.local.set({ 'link2Img': linkImgUrl });
                browser.storage.local.set({ 'link2Padding': num });
                browser.storage.local.set({ 'link2Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link2Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link2': changeLinkInput })
                change('2');
                elemenetGetId('link2').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link3') {
                browser.storage.local.set({ 'link3Img': linkImgUrl });
                browser.storage.local.set({ 'link3Padding': num });
                browser.storage.local.set({ 'link3Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link3Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link3': changeLinkInput })
                change('3');
                elemenetGetId('link3').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link4') {
                browser.storage.local.set({ 'link4Img': linkImgUrl });
                browser.storage.local.set({ 'link4Padding': num });
                browser.storage.local.set({ 'link4Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link4Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link4': changeLinkInput })
                change('4');
                elemenetGetId('link4').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link5') {
                browser.storage.local.set({ 'link5Img': linkImgUrl });
                browser.storage.local.set({ 'link5Padding': num });
                browser.storage.local.set({ 'link5Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link5Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link5': changeLinkInput })
                change('5');
                elemenetGetId('link5').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link6') {
                browser.storage.local.set({ 'link6Img': linkImgUrl });
                browser.storage.local.set({ 'link6Padding': num });
                browser.storage.local.set({ 'link6Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link6Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link6': changeLinkInput })
                change('6');
                elemenetGetId('ithome').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link7') {
                browser.storage.local.set({ 'link7Img': linkImgUrl });
                browser.storage.local.set({ 'link7Padding': num });
                browser.storage.local.set({ 'link7Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link7Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link7': changeLinkInput })
                change('7');
                elemenetGetId('chromeStore').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link8') {
                browser.storage.local.set({ 'link8Img': linkImgUrl });
                browser.storage.local.set({ 'link8Padding': num });
                browser.storage.local.set({ 'link8Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link8Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link8': changeLinkInput })
                change('8');
                elemenetGetId('aliyun').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link9') {
                browser.storage.local.set({ 'link9Img': linkImgUrl });
                browser.storage.local.set({ 'link9Padding': num });
                browser.storage.local.set({ 'link9Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link9Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link9': changeLinkInput })
                change('9');
                elemenetGetId('azure').href = changeLinkInput;
                close();
            }
            if (elemenetGetId('linkNum').className == 'link10') {
                browser.storage.local.set({ 'link10Img': linkImgUrl });
                browser.storage.local.set({ 'link10Padding': num });
                browser.storage.local.set({ 'link10Width': numi * 2 + 50 });
                browser.storage.local.set({ 'link10Height': numi * 2 + 50 });
                browser.storage.local.set({ 'link10': changeLinkInput })
                change('10');
...
export function useLinkChange() {
    browser.storage.local.get(['link1Img', 'link1Padding', 'link1Width', 'link1Height', 'link1'], function (budget) {
        let num = '1';
    ...
    browser.storage.local.get(['link2Img', 'link2Padding', 'link2Width', 'link2Height', 'link2'], function (budget) {
        let num = '2'
    ...
    browser.storage.local.get(['link3Img', 'link3Padding', 'link3Width', 'link3Height', 'link3'], function (budget) {
        let num = '3';
    ...
    browser.storage.local.get(['link4Img', 'link4Padding', 'link4Width', 'link4Height', 'link4'], function (budget) {
        let num = '4';
    ...
    browser.storage.local.get(['link5Img', 'link5Padding', 'link5Width', 'link5Height', 'link5'], function (budget) {
        let num = '5';
    ...
    browser.storage.local.get(['link6Img', 'link6Padding', 'link6Width', 'link6Height', 'link6'], function (budget) {
        let num = '6';
    ...
    browser.storage.local.get(['link7Img', 'link7Padding', 'link7Width', 'link7Height', 'link7'], function (budget) {
        let num = '7';
    ...
    browser.storage.local.get(['link8Img', 'link8Padding', 'link8Width', 'link8Height', 'link8'], function (budget) {
        let num = '8';
    ...
    browser.storage.local.get(['link9Img', 'link9Padding', 'link9Width', 'link9Height', 'link9'], function (budget) {
        let num = '9';
    ...
    browser.storage.local.get(['link10Img', 'link10Padding', 'link10Width', 'link10Height', 'link10'], function (budget) {
        let num = '10';
